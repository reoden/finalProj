...
const downFile = (id: any) => {
  return axios.get(`/restaurant/admin/apps/${id}/download`)
}
...
const shopDetail = (id: any) => {
  return axios.get(`/restaurant/admin/apps/${id}/detail`, {
    paramsSerializer: (obj) => {
      return qs.stringify(obj);
    },
  });
...
// 后台->审核
const examineShop = (data: any) => {
  return axios.put(`/restaurant/admin/apps/${data.id}`, { status: data.status });
}
...
// 大奖排序
const changePrize = (params?: any) => {
  return axios.put('/restaurant/admin/prizeShowList', params);
}

// 添加大奖
const addPrize = (data: any) => {
  return axios.post('/restaurant/admin/prizeShowList', data);
}

// 删除大奖
const deletePrize = (id: any) => {
  return axios.delete(`/restaurant/admin/prizeShowList/${id}`);
}
...
// 切换是否展示大奖
const changePrizeConfig = (params: any) => {
  return axios.put('/restaurant/admin/config', params);
}
...
// 大奖广告位列表
const changePrizeBanner = (params: any) => {
  return axios.put('/restaurant/admin/prizeShowList/banner', params);
}
...
// 展示位列表
const changeStaticBanner = (id: any, params: any) => {
  return axios.put(`/restaurant/admin/static_banner_pic_show/${id}`, params);
}
...
// logo列表
const changeStaticLogo = (params: any) => {
  return axios.put('/restaurant/admin/logo', params);
}

// 修改菜单名称
const renameMenu = (params: any) => {
  return axios.put('/restaurant/admin/config/rename', params);
}
